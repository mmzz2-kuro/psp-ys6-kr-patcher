...
def execute(args)->dict:
 ...
 castinfo_rows=[];item_rows=[];extra_replacements=[];init_original=None;patched_init=None;option_menu_report=None;additional_image_reports=[];ending_movie_reports=[]
